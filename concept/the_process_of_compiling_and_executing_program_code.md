...
![jvm](../images/The_process_of_compiling_and_executing_program_code.png)

Функция f1 хранится в файле a2.c

![jvm](../images/The_process_of_compiling_and_executing_program_code%7B2%7D.png)

Функция f2 хранится в файле a3.c

![jvm](../images/The_process_of_compiling_and_executing_program_code%7B3%7D.png)
...
![jvm](../images/The_process_of_compiling_and_executing_program_code%7B4%7D.png)
...
![jvm](../images/The_process_of_compiling_and_executing_program_code%7B5%7D.png)

Во время выполнения программы программа-загрузчик загрузит файл a.exe в оперативную память для выполнения.

![jvm](../images/The_process_of_compiling_and_executing_program_code%7B6%7D.png)
